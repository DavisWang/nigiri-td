...
export const TOWER_DATA = [
    ...
    { id: 'fox', name: 'Fox', emoji: '🦊', description: 'Long-range precision. Hits multiple targets per shot at tier 2–3.', primary: '#E64A19', accent: '#FFF8E1', eyeColor: '#FF8F00', tiers: [{ cost: 100, damage: 10, range: 2.5, speed: 900, special: null },{ cost: 100, damage: 14, range: 3.0, speed: 880, special: { type: 'multiTarget', count: 2 } },{ cost: 125, damage: 20, range: 3.5, speed: 770, special: { type: 'multiTarget', count: 3 } }] },
    { id: 'monkey', name: 'Monkey', emoji: '🐒', description: 'Ranged hurler. Light slow at tier 2; stronger at tier 3.', primary: '#A1887F', accent: '#FFCCBC', eyeColor: '#5D4037', tiers: [{ cost: 100, damage: 12, range: 3.0, speed: 1000, special: null },{ cost: 100, damage: 16, range: 3.0, speed: 935, special: { type: 'slow', pct: 0.14, dur: 900 } },{ cost: 125, damage: 23, range: 3.5, speed: 770, special: { type: 'slow', pct: 0.27, dur: 1000 } }] },
